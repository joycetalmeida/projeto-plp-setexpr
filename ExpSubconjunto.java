...
public class ExpSubconjunto implements Expressao {

    private Expressao esq, dir;

    public ExpSubconjunto(Expressao esq, Expressao dir) {
        this.esq = esq;
        this.dir = dir;
    }
    ...
    public Valor avaliar(AmbienteExecucao amb) {
        ...
        if (valEsq instanceof ValorConjunto && valDir instanceof ValorConjunto) {
            ...
            throw new RuntimeException("Operacao 'subset' exige dois conjuntos como operandos.");
        }
    }

...
/**
 * Um objeto desta classe representa uma Expressao de Menor ou Igual Que (<=).
 */
public class ExpLe extends ExpBinaria {

    /**
     * Controi uma Expressao de Menor ou Igual Que com as sub-expressoes
     * especificadas.
    ...
    /**
     * Retorna o valor da Expressao de Menor ou Igual Que
     */
    ...
    public ExpBinaria clone() {
        return new ExpLe(esq.clone(), dir.clone());
    }
}

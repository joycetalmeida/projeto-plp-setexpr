...
/**
 * Um objeto desta classe representa uma Expressao de Modulo (resto da divisao).
 */
public class ExpRem extends ExpBinaria {

    /**
     * Controi uma Expressao de Modulo com as sub-expressoes especificadas.
    ...
    /**
     * Retorna o valor da Expressao de Modulo
     */

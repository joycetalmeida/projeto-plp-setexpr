...
/**
 * Um objeto desta classe representa uma Expressao de Diferenca (!=).
 */
public class ExpNe extends ExpBinaria {

    /**
     * Controi uma Expressao de Diferenca com as sub-expressoes especificadas.
    ...
    /**
     * Retorna o valor da Expressao de Diferenca
     */

...
/**
 * Um objeto desta classe representa uma Expressao de Maior ou Igual Que (>=).
 */
public class ExpGe extends ExpBinaria {

    /**
     * Controi uma Expressao de Maior ou Igual Que com as sub-expressoes
     * especificadas.
    ...
    /**
     * Retorna o valor da Expressao de Maior ou Igual Que
     */
    ...
    public ExpBinaria clone() {
        return new ExpGe(esq.clone(), dir.clone());
    }
}

...
public class ExpFilter implements Expressao {
    ...
    public ExpFilter(Id id, Expressao expressaoConjunto, Expressao expressaoCondicao) { this.id = id; this.expressaoConjunto = expressaoConjunto; this.expressaoCondicao = expressaoCondicao; }
...
@Override
    ...
    public boolean checaTipo(AmbienteCompilacao amb) throws VariavelNaoDeclaradaException, VariavelJaDeclaradaException {
        ...
        boolean condOK = expressaoCondicao.checaTipo(amb) && expressaoCondicao.getTipo(amb).eBooleano();
        if (!condOK) {
            throw new VariavelNaoDeclaradaException(new Id("Condição da compreensão de conjunto deve ser Booleana."));
        }
    ...
    @Override
    public Expressao clone() { return new ExpFilter(id.clone(), expressaoConjunto.clone(), expressaoCondicao.clone()); }
}